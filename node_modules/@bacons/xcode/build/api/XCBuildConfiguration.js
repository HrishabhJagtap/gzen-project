...
const xcconfig = __importStar(require("../xcconfig"));
...
class XCBuildConfiguration extends AbstractObject_1.AbstractObject {
    ...
    getBaseConfigurationFilePath() {
        ...
        if (sourceTree === "<group>" || sourceTree === "SOURCE_ROOT") {
            return node_path_1.default.join(root, filePath);
        }
        if (sourceTree === "<absolute>" || node_path_1.default.isAbsolute(filePath)) {
            return filePath;
        }
        return node_path_1.default.join(root, filePath);
    }
     ...
     */
    getBaseConfigurationSettings(options) {
