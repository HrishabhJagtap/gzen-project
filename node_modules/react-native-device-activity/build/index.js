...
export function isWebContentFilterPolicyActive() {
    return (ReactNativeDeviceActivityModule?.isWebContentFilterPolicyActive() ?? false);
}
...
export function setWebContentFilterPolicy(policy, triggeredBy) {
    try {
        return ReactNativeDeviceActivityModule?.setWebContentFilterPolicy(policy, triggeredBy);
    }
    catch (error) {
        handleScreenTimeError(error);
    }
}
export function clearWebContentFilterPolicy(triggeredBy) {
    return ReactNativeDeviceActivityModule?.clearWebContentFilterPolicy(triggeredBy);
}
